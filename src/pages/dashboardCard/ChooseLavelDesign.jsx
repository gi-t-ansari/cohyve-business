...
function ChooseDesigner() {
  ...
  const handleProceed = () => {
    ...
    navigate("/importantNotice-design"); // Replace '/next-page' with the actual route for the next page
  };
    ...
    <DashboardLayout>
      <div className="w-full h-full p-6 bg-[#1A1A1A]">
        ...
        <div className="mt-4">
         ...
         {/* Budget Display */}
         <div className="bg-[#161616] p-7 rounded-lg w-[400px] h-[80px]  border-2  border-red-700">
            <span className="text-[#FF4949] f-HelveticaNeueRoman ">₹ 10,000</span>
            <span className="ml-40 text-[#FF4949] f-HelveticaNeueRoman">
             Not  Enough
            </span>
          </div>
